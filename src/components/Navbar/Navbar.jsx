...
const ProfileDropDown = (props) => {
  ...
  return (
    <div className={`relative ${props.class} font-poppins`}>
      ...
      <ul
        className={`bg-primary top-12 right-0 mt-5 space-y-5 lg:absolute lg:border lg:rounded-md lg:text-sm lg:w-52 lg:shadow-md lg:space-y-0 lg:mt-0 ${
          state ? "" : "lg:hidden"
        }`}
      >
    ...
    <nav className="bg-primary border-b shadow-md font-poppins">
      <div className="flex items-center space-x-8 py-3 px-4 max-w-screen-xl mx-auto md:px-8">
        ...
        <div className="flex-1 flex items-center justify-between">
          <div
            className={`bg-primary absolute z-20 w-full top-16 left-0 p-4 border-b lg:static lg:block lg:border-none ${
              menuState ? "" : "hidden"
            }`}
          >
